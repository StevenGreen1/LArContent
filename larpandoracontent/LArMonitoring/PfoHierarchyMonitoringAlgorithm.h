/**
 *  @file   larpandoracontent/LArMonitoring/PfoHierarchyMonitoringAlgorithm.h
 *
 *  @brief  Header file for the pfo hierarchy monitoring algorithm.
 *
 *  $Log: $
 */
#ifndef LAR_PFO_HIERARCHY_MONITORING_ALGORITHM_H
#define LAR_PFO_HIERARCHY_MONITORING_ALGORITHM_H 1
...
/**
 *  @brief  PfoHierarchyMonitoringAlgorithm class
 */
class PfoHierarchyMonitoringAlgorithm: public pandora::Algorithm
{
public:
    /**
     *  @brief  Default constructor
     */
    PfoHierarchyMonitoringAlgorithm();
...
inline const LArMCParticleHelper::MCContributionMap &PfoHierarchyMonitoringAlgorithm::ValidationInfo::GetAllMCParticleToHitsMap() const
{
...
inline const LArMCParticleHelper::MCContributionMap &PfoHierarchyMonitoringAlgorithm::ValidationInfo::GetTargetMCParticleToHitsMap() const
{
...
inline const LArMCParticleHelper::PfoContributionMap &PfoHierarchyMonitoringAlgorithm::ValidationInfo::GetPfoToHitsMap() const
{
...
inline const LArMCParticleHelper::MCParticleToPfoHitSharingMap &PfoHierarchyMonitoringAlgorithm::ValidationInfo::GetMCToPfoHitSharingMap() const
{
...
inline const LArMCParticleHelper::MCParticleToPfoHitSharingMap &PfoHierarchyMonitoringAlgorithm::ValidationInfo::GetInterpretedMCToPfoHitSharingMap() const
{
...
inline void PfoHierarchyMonitoringAlgorithm::ValidationInfo::SetAllMCParticleToHitsMap(const LArMCParticleHelper::MCContributionMap &allMCParticleToHitsMap)
{
...
inline void PfoHierarchyMonitoringAlgorithm::ValidationInfo::SetTargetMCParticleToHitsMap(const LArMCParticleHelper::MCContributionMap &targetMCParticleToHitsMap)
{
...
inline void PfoHierarchyMonitoringAlgorithm::ValidationInfo::SetPfoToHitsMap(const LArMCParticleHelper::PfoContributionMap &pfoToHitsMap)
{
...
inline void PfoHierarchyMonitoringAlgorithm::ValidationInfo::SetMCToPfoHitSharingMap(const LArMCParticleHelper::MCParticleToPfoHitSharingMap &mcToPfoHitSharingMap)
{
...
inline void PfoHierarchyMonitoringAlgorithm::ValidationInfo::SetInterpretedMCToPfoHitSharingMap(const LArMCParticleHelper::MCParticleToPfoHitSharingMap &interpretedMCToPfoHitSharingMap)
{
...
inline void PfoHierarchyMonitoringAlgorithm::PrintAllMatches(const ValidationInfo &validationInfo) const
{
...
inline void PfoHierarchyMonitoringAlgorithm::PrintInterpretedMatches(const ValidationInfo &validationInfo) const
{
...
inline void PfoHierarchyMonitoringAlgorithm::WriteInterpretedMatches(const ValidationInfo &validationInfo) const
{
...
#endif // LAR_PFO_HIERARCHY_MONITORING_ALGORITHM_H
